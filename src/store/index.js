...
const store = new Vuex.Store({
  state: {
    memos: [
      ...
      { id: 9, title: 'ゼルダの伝説 トワイライトプリンセス', description: '『ゼルダの伝説 トワイライトプリンセス』（ゼルダのでんせつ トワイライトプリンセス、英題:The Legend of Zelda: Twilight Princess）は、任天堂より発売された、Wii・ニンテンドーゲームキューブ用のアクションアドベンチャーゲーム。略称は「トワプリ」。', platforms: ['GC', 'Wii'], million: false, releasedAt: new Date('2006-12-02') },
      { id: 10, title: 'ゼルダの伝説 夢幻の砂時計', description: '『ゼルダの伝説 夢幻の砂時計』（ゼルダのでんせつ むげんのすなどけい、英題:The Legend of Zelda: Phantom Hourglass）は、任天堂開発・発売のニンテンドーDS専用ゲームソフト。略称は「夢砂」「夢幻」など。', platforms: ['DS'], million: false, releasedAt: new Date('2007-06-23') },
      { id: 11, title: 'ゼルダの伝説 大地の汽笛', description: '『ゼルダの伝説 大地の汽笛』（ゼルダのでんせつ だいちのきてき、英題:The Legend of Zelda: Spirit Tracks）は、任天堂から平成20年12月23日に発売されたニンテンドーDS用アクションアドベンチャーゲーム。略称は「汽笛」など。', platforms: ['DS'], million: false, releasedAt: new Date('2009-12-07') },
      { id: 12, title: 'ゼルダの伝説 スカイウォードソード', description: '『ゼルダの伝説 スカイウォードソード』（ゼルダのでんせつ スカイウォードソード、英題：The Legend of Zelda: Skyward Sword）は、任天堂より平成22年11月23日に発売されたWii用アクションアドベンチャーゲーム。2016年9月2日からはWii U用ダウンロードソフトとして配信されている。', platforms: ['Wii', 'Wii U'], million: false, releasedAt: new Date('2011-11-23') },
      { id: 13, title: 'ゼルダの伝説 神々のトライフォース2', description: '『ゼルダの伝説 神々のトライフォース2』（ゼルダのでんせつ かみがみのトライフォースツー、英題：The Legend of Zelda: A Link Between Worlds）は、平成25年12月26日に任天堂から発売されたニンテンドー3DS用アクションアドベンチャーゲーム。', platforms: ['3DS'], million: false, releasedAt: new Date('2013-12-26') },
      { id: 14, title: 'ゼルダの伝説 ブレス オブ ザ ワイルド', description: '『ゼルダの伝説 ブレス オブ ザ ワイルド』（ゼルダのでんせつ ブレス オブ ザ ワイルド、英題:The Legend of Zelda: Breath of the Wild）は、任天堂より平成29年3月3日に発売されたWii UおよびNintendo Switch用アクションアドベンチャーゲーム。', platforms: ['Wii U', 'Switch'], million: true, releasedAt: new Date('2017-03-03') }
    ],
    nextId: 15
  },
  mutations: {
